...
var or__30230__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj38898 = {"detail":data};
return obj38898;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30218__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30218__auto__)){
var and__30218__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__38905 = cljs.core._EQ_;
var expr__38906 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__38905.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__38906))){
return ((function (pred__38905,expr__38906){
return (function (p1__38899_SHARP_){
return console.warn(p1__38899_SHARP_);
});
;})(pred__38905,expr__38906))
} else {
if(cljs.core.truth_(pred__38905.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__38906))){
return ((function (pred__38905,expr__38906){
return (function (p1__38900_SHARP_){
return console.debug(p1__38900_SHARP_);
});
;})(pred__38905,expr__38906))
} else {
if(cljs.core.truth_(pred__38905.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__38906))){
return ((function (pred__38905,expr__38906){
return (function (p1__38901_SHARP_){
return console.error(p1__38901_SHARP_);
});
;})(pred__38905,expr__38906))
} else {
return ((function (pred__38905,expr__38906){
return (function (p1__38902_SHARP_){
return console.log(p1__38902_SHARP_);
});
;})(pred__38905,expr__38906))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__38909){
var map__38910 = p__38909;
var map__38910__$1 = ((((!((map__38910 == null)))?((((map__38910.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38910.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38910):map__38910);
var opts = map__38910__$1;
var eval_fn = cljs.core.get.call(null,map__38910__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__38912_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__38914,(0),null);
var v = cljs.core.nth.call(null,vec__38914,(1),null);
...
if(cljs.core.truth_((function (){var and__30218__auto__ = typeof localStorage !== 'undefined';
...
}catch (e38919){if((e38919 instanceof Error)){
var e = e38919;
return not_found;
} else {
throw e38919;
...
//# sourceMappingURL=utils.js.map?rel=1514673225786
