...
var G__42238 = devtools.prefs.pref.call(null,v);
v = G__42238;
continue;
} else {
return v;
...
var and__30218__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__30218__auto__){
var and__30218__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__30230__auto__ = (function (){try{if(!((value == null))){
...
}catch (e42241){var _e__41964__auto__ = e42241;
return false;
}})();
if(cljs.core.truth_(or__30230__auto__)){
return or__30230__auto__;
} else {
var or__30230__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e42245){var _e__41964__auto__ = e42245;
return false;
}})();
...
}catch (e42247){var _e__41964__auto__ = e42247;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__30218__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30218__auto__)){
var and__30218__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__30218__auto____$1){
...
var and__30218__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__30218__auto__)){
...
var or__30230__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__30230__auto__)){
return or__30230__auto__;
} else {
...
var and__30218__auto__ = (function (){var or__30230__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__30230__auto__)){
return or__30230__auto__;
} else {
...
var vec__42249 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__42249,(0),null);
var name = cljs.core.nth.call(null,vec__42249,(1),null);
...
var and__30218__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__30218__auto__)){
...
var or__30230__auto__ = typeof value === 'string';
if(or__30230__auto__){
return or__30230__auto__;
} else {
var or__30230__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__42252_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42252_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1514673229065
