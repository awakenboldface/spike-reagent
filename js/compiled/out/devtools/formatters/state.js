...
var len__31509__auto___42258 = arguments.length;
var i__31510__auto___42259 = (0);
while(true){
if((i__31510__auto___42259 < len__31509__auto___42258)){
args__31516__auto__.push((arguments[i__31510__auto___42259]));

var G__42260 = (i__31510__auto___42259 + (1));
i__31510__auto___42259 = G__42260;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31517__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq42256){
var G__42257 = cljs.core.first.call(null,seq42256);
var seq42256__$1 = cljs.core.next.call(null,seq42256);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__42257,seq42256__$1);
});
...
return (p1__42261_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1514673229093
