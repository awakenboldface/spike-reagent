...
var reader = (function (){var or__30230__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__30230__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__30230__auto__)){
return or__30230__auto__;
} else {
return (128);
...
}catch (e44032){var _e = e44032;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___44035 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___44035)){
var seen_errors_44036 = temp__5455__auto___44035;
if(cljs.core.truth_(seen_errors_44036.has(self))){
} else {
seen_errors_44036.add(self);

var temp__5457__auto___44037 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___44037)){
var sense_44038 = temp__5457__auto___44037;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_44038)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1514673231857
